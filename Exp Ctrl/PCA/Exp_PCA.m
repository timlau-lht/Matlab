...
for(i=1:1:1)
    ...
    [HammingLoss,RankingLoss,OneError,Coverage,AveragePrecision,AUC,F1_macro,F1_micro] = PCA_Main(X_t, X_s, Y_t, Y_s);
...
save('PCA.mat','-mat','MMLTL_HL','MMLTL_RL','MMLTL_OE','MMLTL_C','MMLTL_AP','Time_Start','Time_End');
%% 播放提示音
load chirp
sound(y,Fs)
end
