function [Outputs,Threshold,Pre_Labels]=RankSVM_test(test_data,test_target,svm,Weights,Bias,SVs,Weights_sizepre,Bias_sizepre)
...
[num_testing,~]=size(test_data);
[num_class,~]=size(test_target);
[~,num_training]=size(SVs);
